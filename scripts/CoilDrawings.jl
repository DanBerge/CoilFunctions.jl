using Unitful, Colors, Luxor

@png begin
    for (r,c) in zip(150:-50:50,["red","green","blue"])
        setcolor(c)
...
illustratecoil(:SBE5,24u"V",0.9;filename=joinpath(fdir,"SBE5 24V.png"),resolution=(800,300))
illustratecoil(:SBE5,104u"V",0.9;filename=joinpath(fdir,"SBE5 104V.png"),resolution=(800,300))
illustratecoil(:SBE5,115u"V",0.9;filename=joinpath(fdir,"SBE5 115V.png"),resolution=(800,300))
illustratecoil(:SBE5,116u"V",0.9;filename=joinpath(fdir,"SBE5 116V.png"),resolution=(800,300))
